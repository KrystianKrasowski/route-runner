...
static gpio_definition_t gpio[9] = {
    ...
    [GPIO_MOTOR_LEFT_A1] = {RCC_AHBENR_GPIOAEN, GPIOA, 12},
    [GPIO_MOTOR_LEFT_A2] = {RCC_AHBENR_GPIOAEN, GPIOA, 10},
    [GPIO_MOTOR_RIGHT_A1] = {RCC_AHBENR_GPIOBEN, GPIOB, 6},
    [GPIO_MOTOR_RIGHT_A2] = {RCC_AHBENR_GPIOBEN, GPIOB, 7},
};
